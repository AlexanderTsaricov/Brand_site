...
[
    ...
    {
        "srcImg": "cart/womanInBlackJacet.png",
        "productName": "ELLERY X M'O CAPSULE",
        "productDiscription": "Known for her sculptural takes on traditional tailoring, Australian arbiter of cool Kym Ellery teams up with Moda Operandi.",
        "productPrice": 52.00
    ...
    {
        "srcImg": "cart/womanInBlueJacet.png",
        "productName": "ELLERY X M'O CAPSULE",
        "productDiscription": "Known for her sculptural takes on traditional tailoring, Australian arbiter of cool Kym Ellery teams up with Moda Operandi.",
        "productPrice": 52.00
    ...
    {
        "srcImg": "cart/womanInGreenJacet.png",
        "productName": "ELLERY X M'O CAPSULE",
        "productDiscription": "Known for her sculptural takes on traditional tailoring, Australian arbiter of cool Kym Ellery teams up with Moda Operandi.",
        "productPrice": 52.00
...
function createProductBlock(jsonDict) {
    const headDIv = document.createElement("div");
    headDIv.classList.add("productCartBox_cartBox_cart");

    const productImg = document.createElement("img");
    productImg.src = jsonDict.srcImg;
    productImg.alt = "cart pic";
    productImg.classList.add("productCartBox_cartBox_cart_img");

    const hoverBlock = document.createElement("div");
    hoverBlock.classList.add("productCartBox_cartBox_cart_hover");
    ...
    textBox.classList.add("productCartBox_cartBox_cart_textBox");

    const productName = document.createElement("h3");
    productName.textContent = jsonDict.productName;
    textBox.appendChild(productName);

    const productDiscription = document.createElement("p");
    productDiscription.classList.add("productCartBox_cartBox_cart_text");
    productDiscription.textContent = jsonDict.productDiscription;
    textBox.appendChild(productDiscription);

    const productPrice = document.createElement("p");
    productPrice.classList.add("productCartBox_cartBox_cart_price");
    productPrice.textContent = `$${jsonDict.productPrice}`;
    textBox.appendChild(productPrice);

    headDIv.appendChild(productImg);
    headDIv.appendChild(hoverBlock);
    headDIv.appendChild(textBox);

    return headDIv;
}

const productDataJson = JSON.parse(jsonString);
const productCartBox = document.querySelector(".productCartBox_cartBox");
productDataJson.forEach((productDict) => {
    productCartBox.appendChild(createProductBlock(productDict));
});
